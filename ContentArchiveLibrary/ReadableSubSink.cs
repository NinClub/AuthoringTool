...
// Type: Nintendo.Authoring.AuthoringLibrary.ReadableSubSink
...
{
  public class ReadableSubSink : IReadableSink, ISink
  {
    ...
    {
      return (ISource) new SubSource(this.m_sink.ToSource(), this.m_offset, this.Size);
    }
  }
}

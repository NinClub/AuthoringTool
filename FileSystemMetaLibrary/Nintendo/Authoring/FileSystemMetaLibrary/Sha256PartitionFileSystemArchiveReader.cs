...
// Type: Nintendo.Authoring.FileSystemMetaLibrary.Sha256PartitionFileSystemArchiveReader
...
{
  public class Sha256PartitionFileSystemArchiveReader : IFileSystemArchiveReader, IDisposable
  {
    private unsafe Sha256PartitionFileSystemArchiveReaderImpl* m_Impl;

    internal unsafe Sha256PartitionFileSystemArchiveReader(shared_ptr\u003Cnn\u003A\u003Afs\u003A\u003AIStorage\u003E* storage)
    {
      // ISSUE: fault handler
      try
      {
        ...
        base.\u002Ector();
        Sha256PartitionFileSystemArchiveReaderImpl* archiveReaderImplPtr1 = (Sha256PartitionFileSystemArchiveReaderImpl*) \u003CModule\u003E.@new(20U);
        Sha256PartitionFileSystemArchiveReaderImpl* archiveReaderImplPtr2;
        // ISSUE: fault handler
        try
        {
          if ((IntPtr) archiveReaderImplPtr1 != IntPtr.Zero)
          {
            ...
            archiveReaderImplPtr2 = \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002ESha256PartitionFileSystemArchiveReaderImpl\u002E\u007Bctor\u007D(archiveReaderImplPtr1, &sharedPtrNnFsIstorage);
          }
          else
            archiveReaderImplPtr2 = (Sha256PartitionFileSystemArchiveReaderImpl*) 0;
        }
        __fault
        {
    ...
    public unsafe Sha256PartitionFileSystemArchiveReader(Stream stream)
    {
      ...
      try
      {
        ...
        try
        {
          if ((IntPtr) archiveReaderImplPtr1 != IntPtr.Zero)
          {
            ...
            archiveReaderImplPtr2 = \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002ESha256PartitionFileSystemArchiveReaderImpl\u002E\u007Bctor\u007D(archiveReaderImplPtr1, &sharedPtrNnFsIstorage2);
          }
          else
            archiveReaderImplPtr2 = (Sha256PartitionFileSystemArchiveReaderImpl*) 0;
        }
    ...
    private void \u007ESha256PartitionFileSystemArchiveReader()
    {
      this.\u0021Sha256PartitionFileSystemArchiveReader();
    }

    private unsafe void \u0021Sha256PartitionFileSystemArchiveReader()
    {
      Sha256PartitionFileSystemArchiveReaderImpl* impl = this.m_Impl;
      if ((IntPtr) impl == IntPtr.Zero)
        return;
      \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002ESha256PartitionFileSystemArchiveReaderImpl\u002E\u007Bdtor\u007D(impl);
    ...
    {
      List<Tuple<long, long>> fileFragmentList = \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002ESha256PartitionFileSystemArchiveReaderImpl\u002EGetFileFragmentList(this.m_Impl, fileName);
      GC.KeepAlive((object) this);
    ...
    internal unsafe void OpenFileStorage(shared_ptr\u003Cnn\u003A\u003Afs\u003A\u003AIStorage\u003E* outValue, string fileName)
    {
      \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002ESha256PartitionFileSystemArchiveReaderImpl\u002EOpenFileStorage(this.m_Impl, outValue, fileName);
      GC.KeepAlive((object) this);
    }

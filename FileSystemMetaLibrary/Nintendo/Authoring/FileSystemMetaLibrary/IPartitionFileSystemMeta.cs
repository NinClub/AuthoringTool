...
// Type: Nintendo.Authoring.FileSystemMetaLibrary.IPartitionFileSystemMeta
...
{
  public interface IPartitionFileSystemMeta
  {
    byte[] Create(PartitionFileSystemInfo fileSystemInfo);
  }
}

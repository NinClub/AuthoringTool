...
// Type: Nintendo.Authoring.FileSystemMetaLibrary.PartitionFileSystemArchiveReader
...
{
  public class PartitionFileSystemArchiveReader : IFileSystemArchiveReader, IDisposable
  {
    private unsafe PartitionFileSystemArchiveReaderImpl* m_Impl;

    internal unsafe PartitionFileSystemArchiveReader(shared_ptr\u003Cnn\u003A\u003Afs\u003A\u003AIStorage\u003E* storage)
    {
      // ISSUE: fault handler
      try
      {
        ...
        base.\u002Ector();
        PartitionFileSystemArchiveReaderImpl* archiveReaderImplPtr1 = (PartitionFileSystemArchiveReaderImpl*) \u003CModule\u003E.@new(20U);
        PartitionFileSystemArchiveReaderImpl* archiveReaderImplPtr2;
        // ISSUE: fault handler
        try
        {
          if ((IntPtr) archiveReaderImplPtr1 != IntPtr.Zero)
          {
            ...
            archiveReaderImplPtr2 = \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002EPartitionFileSystemArchiveReaderImpl\u002E\u007Bctor\u007D(archiveReaderImplPtr1, &sharedPtrNnFsIstorage);
          }
          else
            archiveReaderImplPtr2 = (PartitionFileSystemArchiveReaderImpl*) 0;
        }
        __fault
        {
    ...
    public unsafe PartitionFileSystemArchiveReader(Stream stream)
    {
      ...
      try
      {
        ...
        try
        {
          if ((IntPtr) archiveReaderImplPtr1 != IntPtr.Zero)
          {
            ...
            archiveReaderImplPtr2 = \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002EPartitionFileSystemArchiveReaderImpl\u002E\u007Bctor\u007D(archiveReaderImplPtr1, &sharedPtrNnFsIstorage2);
          }
          else
            archiveReaderImplPtr2 = (PartitionFileSystemArchiveReaderImpl*) 0;
        }
    ...
    private void \u007EPartitionFileSystemArchiveReader()
    {
      this.\u0021PartitionFileSystemArchiveReader();
    }

    private unsafe void \u0021PartitionFileSystemArchiveReader()
    {
      PartitionFileSystemArchiveReaderImpl* impl = this.m_Impl;
      if ((IntPtr) impl == IntPtr.Zero)
        return;
      \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002EPartitionFileSystemArchiveReaderImpl\u002E\u007Bdtor\u007D(impl);
    ...
    {
      List<Tuple<long, long>> fileFragmentList = \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002EPartitionFileSystemArchiveReaderImpl\u002EGetFileFragmentList(this.m_Impl, fileName);
      GC.KeepAlive((object) this);
    ...
    {
      \u003CModule\u003E.Nintendo\u002EAuthoring\u002EFileSystemMetaLibrary\u002EPartitionFileSystemArchiveReaderImpl\u002EOpenFileStorage(this.m_Impl, outValue, fileName);
      GC.KeepAlive((object) this);
    }
    ...
    ~PartitionFileSystemArchiveReader()
    {
      this.Dispose(false);
    }
  }

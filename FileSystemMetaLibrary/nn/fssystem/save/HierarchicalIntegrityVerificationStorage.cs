...
// Type: nn.fssystem.save.HierarchicalIntegrityVerificationStorage
...
namespace nn.fssystem.save
{
  ...
  internal struct HierarchicalIntegrityVerificationStorage
  {
    [NativeCppClass]
    [CLSCompliant(false)]
    [UnsafeValueType]
    [StructLayout(LayoutKind.Sequential, Size = 224)]
    public struct HierarchicalStorageInformation
    {
    }
  }
}
